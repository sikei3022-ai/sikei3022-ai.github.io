...
wget -q -O server.js.new "https://sikei3022-ai.github.io/server.js" || { echo "НЕ СКАЧАЛ"; exit 1; }
if node -c server.js.new; then mv server.js.new server.js; echo "server.js обновлён ОК"; else echo "СИНТАКС-ОШИБКА — откат"; rm -f server.js.new; exit 1; fi
